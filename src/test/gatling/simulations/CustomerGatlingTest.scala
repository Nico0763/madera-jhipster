...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "firstname":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "pc":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "phone_number":"SAMPLE_TEXT", "mail":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
