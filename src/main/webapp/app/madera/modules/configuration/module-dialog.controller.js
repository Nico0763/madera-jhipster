(function() {
    ...
    angular
        .module('maderaApp')
        .controller('_ModuleDialogController', _ModuleDialogController);

    _ModuleDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Module', 'Principal_cross_section', 'Module_nature', 'Product', 'Assortment', 'Module_component'];

    function _ModuleDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Module, Principal_cross_section, Module_nature, Product, Assortment, Module_component) {
        var vm = this;
