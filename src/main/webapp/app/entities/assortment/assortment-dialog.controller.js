(function() {
    ...
    angular
        .module('maderaApp')
        .controller('AssortmentDialogController', AssortmentDialogController);

    AssortmentDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Assortment', 'Finition_ext', 'Insulating_type', 'Frame', 'Cover_type', 'Module', 'Pattern', 'Quotation'];

    function AssortmentDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Assortment, Finition_ext, Insulating_type, Frame, Cover_type, Module, Pattern, Quotation) {
        var vm = this;
